                ...
                <div class="col-md-12 custom-form">
                    <form @submit.prevent="submitForm">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea v-model="description" class="form-control" id="description" placeholder="Введите текст" rows="15"></textarea>
                      </div>
                      <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <input v-model="delivery_area" type="text" class="form-control" id="delivery_area" placeholder="Введите название области">
                      </div>
                      <div class="mb-3">
                        <label for="delivery_address" class="form-label">Место поставки</label>
                        <input v-model="delivery_address" type="text" class="form-control" id="delivery_address" placeholder="Введите место поставки">
                      </div>
                      <div class="mb-3 d-flex justify-content-between">
                      <div class="me-3">
                        <label for="date-start">Дата начала:</label>
                        <br>
                        <input type="date" id="date-start" name="date-start" value="2024-01-01" min="2024-01-01" max="2100-12-31" v-model="start_date" />
                        <br>
                      ...
                      <div class="ms-auto">
                        ...
                        <br>
                        <input type="date" id="date-end" name="date-end" value="2024-01-02" min="2024-01-01" max="2100-12-31" v-model="end_date" />
                        <br>
